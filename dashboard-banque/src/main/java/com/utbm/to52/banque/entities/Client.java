package com.utbm.to52.banque.entities;
...
public class Client implements Serializable {
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)  //�ad code g�n�rer automatiquement
	@Column (name="CODECLI") //cette annotation n'est pas obligatoire (on peut l'�liminer comme pour les autres attributs et utiliser le nom de l'attribut comme non du colonne )
...
public Client(Long id, String nomClient, String adresseClient ) {
	super();
        this.codeClient = id;
	this.nomClient = nomClient;
	this.adresseClient = adresseClient; 
